...
export class Contract__getPausedStateResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
...
export class Contract__getPoolTokenInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: Address;
...
export class Contract__getPoolTokensResult {
...
export class Contract__queryBatchSwapInputSwapsStruct extends ethereum.Tuple {
  get poolId(): Bytes {
...
export class Contract__queryBatchSwapInputFundsStruct extends ethereum.Tuple {
  get sender(): Address {
...
export class Contract extends ethereum.SmartContract {
  ...
  getPausedState(): Contract__getPausedStateResult {
    let result = super.call(
      "getPausedState",
    ...
    return new Contract__getPausedStateResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getPausedState(): ethereum.CallResult<Contract__getPausedStateResult> {
    let result = super.tryCall(
      "getPausedState",
      "getPausedState():(bool,uint256,uint256)",
      []
    ...
    return ethereum.CallResult.fromValue(
      new Contract__getPausedStateResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  getPool(poolId: Bytes): Contract__getPoolResult {
  ...
  try_getPool(poolId: Bytes): ethereum.CallResult<Contract__getPoolResult> {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__getPoolResult(value[0].toAddress(), value[1].toI32())
    );
  }
  ...
  getPoolTokenInfo(
    poolId: Bytes,
    token: Address
  ): Contract__getPoolTokenInfoResult {
    let result = super.call(
      "getPoolTokenInfo",
    ...
    return new Contract__getPoolTokenInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toAddress()
  ...
  try_getPoolTokenInfo(
    poolId: Bytes,
    token: Address
  ): ethereum.CallResult<Contract__getPoolTokenInfoResult> {
    let result = super.tryCall(
      "getPoolTokenInfo",
      "getPoolTokenInfo(bytes32,address):(uint256,uint256,uint256,address)",
      [ethereum.Value.fromFixedBytes(poolId), ethereum.Value.fromAddress(token)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__getPoolTokenInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toAddress()
  ...
  getPoolTokens(poolId: Bytes): Contract__getPoolTokensResult {
    let result = super.call(
      "getPoolTokens",
    ...
    return new Contract__getPoolTokensResult(
  ...
  try_getPoolTokens(
    poolId: Bytes
  ): ethereum.CallResult<Contract__getPoolTokensResult> {
    let result = super.tryCall(
      "getPoolTokens",
      "getPoolTokens(bytes32):(address[],uint256[],uint256)",
      [ethereum.Value.fromFixedBytes(poolId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__getPoolTokensResult(
  ...
  queryBatchSwap(
    kind: i32,
    swaps: Array<Contract__queryBatchSwapInputSwapsStruct>,
    assets: Array<Address>,
    funds: Contract__queryBatchSwapInputFundsStruct
  ): Array<BigInt> {
    let result = super.call(
      "queryBatchSwap",
